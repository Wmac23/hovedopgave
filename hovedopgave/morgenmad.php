...
<body>
  ...
  <div class="container">
    ...
    <p class="black">Sorter efter:</p><a class="btn btn-success active" href="morgenmad.php">Dato</a> <a
      class="btn btn-success" href="morgenmad_p.php">Pris</a> <br> <br>
    <?php //connect til database
("wimac.dk.mysql", "wimac_dkmadogsu", "12345678910", "wimac_dkmadogsu");

?><?php $sql="select * from morgenmad ORDER BY tid DESC LIMIT 10";
