...
<body>
  ...
  <br> <br>
  <div class="container">
    <h2 class="intro">Frokost opskrifter</h2>
    <p class="black">Sorter efter:</p><a class="btn btn-success active" href="aftensmad.php">Dato</a> <a
      class="btn btn-success " href="aftensmad_p.php">Pris</a> <br> <br>
    <?php //connect til database
$conn=new mysqli("wimac.dk.mysql", "wimac_dkmadogsu", "12345678910", "wimac_dkmadogsu");

?><?php $sql="select * from aftensmad ORDER BY tid DESC LIMIT 10";
