...
<body>
  ...
  <div class="container">
    ...
    <p class="black">Sorter efter:</p><a class="btn btn-success" href="aftensmad.php">Dato</a> <a
      class="btn btn-success active" href="aftensmad_p.php">Pris</a> <br> <br>
    <?php //connect til database
$conn=new mysqli("wimac.dk.mysql", "wimac_dkmadogsu", "12345678910", "wimac_dkmadogsu");

?><?php $sql="select * from aftensmad ORDER BY penge LIMIT 10";
