...
<body>
  ...
  <div class="container card">
    ...
    <div class="row justify-content-center">
      ...
      <h2 class="intro">Opret aftensmad opskrift</h2>
      <form action="new_aft.php" method="POST">

        <label for="">Titel</label>
        <input placeholder="Titel på retten" type="text" name="titel" class="form-control" value="">

        <label for="">Opskrift</label>
        <input placeholder="Forklar opskrift" type="text" name="vejled" class="form-control" value="">

        <label for="quantity">Pris</label>
        <input placeholder="Pris" type="number" name="penge" class="form-control" value="" min="1" max="1000">
        ...
        <input placeholder="Antal personer" type="number" name="personer" class="form-control" value="" min="1"
          max="10">
        <br>
        <button type="Submit" name="save3" onclick="opskrift()">Submit</button>
